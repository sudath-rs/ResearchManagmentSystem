...
<div id="mySidenav" class="sidenav">
  ...
  <a href="book.php">Document</a>
  <a href="addbooks.php">Request Document</a>
...
{ 
  ?><td><button class="btn btn-primary" onclick="location.href = 'student_login.php';">Login</button></td> <?php
