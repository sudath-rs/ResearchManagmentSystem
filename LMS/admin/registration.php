...
<?php include("nav.php");?>
    <div style="margin-top:-20.5px" class="form">
        ...
        <div class="wrapper1">
            ...
            <h1>Registraion</h1>
                <div class="input-box">
                    <input class="form-control" type="text" name="username"  placeholder="AdminID" required="" >
        ...
        <div class="register-link"><p><br>Already have an account ? <a href="admin_login.php">Login</a></p></div>        
            </form>
        </div>
